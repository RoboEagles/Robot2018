...
public class OI {
    ...
    public OI() {
        ...
        ejectButton = new JoystickButton(everyStick, 2);
        ejectButton.whileHeld(new ejectBox());
        grabButton = new JoystickButton(everyStick, 1);
        grabButton.whileHeld(new grabBox());
        ...
        SmartDashboard.putData("changeGoal", new changeGoal());
