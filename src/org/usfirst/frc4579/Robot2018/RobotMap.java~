...
public class RobotMap {
    ...
    public static DigitalInput switchescenterSwitch;
    ...
    public static void init() {
        ...
        switchescenterSwitch = new DigitalInput(3);
        LiveWindow.addSensor("switches", "centerSwitch", switchescenterSwitch);
        
        switchesrightSwitch = new DigitalInput(4);
        LiveWindow.addSensor("switches", "rightSwitch", switchesrightSwitch);
        
        switchesleftSwitch = new DigitalInput(5);
