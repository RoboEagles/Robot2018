...
public class lifter extends PIDSubsystem {
    ...
    public int maxHeight = 121;			// The highest height the lifter can reach
    ...
    // Updates what the current height of the lifter is according to the 
    public void currentHeight(){
    	direction = (int)Math.signum(liftMotor.get());
    	height += direction*IRSensor.get();
    }
